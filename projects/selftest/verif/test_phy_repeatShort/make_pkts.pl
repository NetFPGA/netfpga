...
nf_PCI_write32( 30000, $batch, PHY_TEST_CTRL_REG(), 0x00000002 );

########### Stop the test in repeat mode ################
# Note: This is delayed
nf_PCI_write32( 1200, $batch, PHY_TEST_CTRL_REG(), 0x00000000 );
...
$data_from_1 = "00 ca fe 00 01 01 00 ca fe 00 00 01 f0 3c 00 01 ". '00 'x44;
$data_from_2 = "00 ca fe 00 01 02 00 ca fe 00 00 02 f0 3c 00 01 ". '00 'x44;
$data_from_3 = "00 ca fe 00 01 03 00 ca fe 00 00 03 f0 3c 00 01 ". '00 'x44;
$data_from_4 = "00 ca fe 00 01 04 00 ca fe 00 00 04 f0 3c 00 01 ". '00 'x44;


# expect a packet from port 1 and send it into port 2
nf_expected_packet(1, 60, $data_from_1);
nf_packet_in(2, 60, 20000, 0, $data_from_1);

# expect a packet from port 2 and send it into port 1
nf_expected_packet(2, 60, $data_from_2);
nf_packet_in(1, 60, 20000, 0, $data_from_2);

# expect a packet from port 3 and send it into port 4
nf_expected_packet(3, 60, $data_from_3);
nf_packet_in(4, 60, 20000, 0, $data_from_3);

# expect a packet from port 4 and send it into port 3
nf_expected_packet(4, 60, $data_from_4);
nf_packet_in(3, 60, 20000, 0, $data_from_4);
...
nf_PCI_read32( 50000, $batch, PHY_TEST_STATUS_REG(), 0x00000110 );

for (my $i = 0; $i < 4; $i++) {
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_STATUS_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00010001 );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_ITER_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000003 );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x0000000f );

   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_STATUS_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), (0x00001111 | ((($i ^ 1) + 1) << 16)) );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_GOOD_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x0000000f);
