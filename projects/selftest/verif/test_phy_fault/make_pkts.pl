...
nf_PCI_read32( 20000, $batch, PHY_TEST_STATUS_REG(), 0x00000010 );

for (my $i = 0; $i < 4; $i++) {
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_STATUS_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00010001 );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_ITER_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000001 );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_TX_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000005 );

   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_STATUS_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), (0x00001001 | ((($i ^ 1) + 1) << 16)) );
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_GOOD_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000000);
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_ERR_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000005);

   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_LOG_STATUS_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000f01);
}
