...
nf_PCI_read32( 20000, $batch, PHY_TEST_STATUS_REG(), 0x00000110 );
...
for (my $i = 0; $i < 4; $i++) {
   ...
   nf_PCI_read32( 0, $batch, PHY_TEST_PHY_0_RX_GOOD_PKT_CNT_REG() + $i * PHY_TEST_PHY_GROUP_INST_OFFSET(), 0x00000005);
